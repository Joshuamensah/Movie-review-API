        ...
        {this.state.reviews.map((new_movie) => (
          <div style={{ margin: "40px 0" }}>
            <Card className="text-center" border="primary">
              <Card.Header>
                <h3
                  style={{ fontFamily: "Goudy Old Style", fontWeight: "bold" }}
                >
                  {new_movie.display_title}
                </h3>
              </Card.Header>
              <Card.Body>
                <Row>
                  ...
                  <div className="col-md-8">
                    <Card.Title style={{ marginBottom: "30px" }}>
                      Publication: {new_movie.publication_date}
                    </Card.Title>
                    <Card.Title>
                      <h4 sytle={{ fontWeight: "bold" }}>
                        {new_movie.headline}
                      </h4>
                    </Card.Title>
              ...
              <Card.Footer className="text-muted text-left">
                Date Updated: {new_movie.date_updated}
              </Card.Footer>
            </Card>
          </div>
        ))}
